...
def draw_line_plot():
    ...
    fig = df.plot(kind='line', color='red', legend=False, xlabel='Date', ylabel='Page Views', title='Daily freeCodeCamp Forum Page Views 5/2016-12/2019').figure
...
def draw_bar_plot():
    ...
    # Draw bar plot
    fig = df_bar.plot(kind='bar', xlabel='Years', ylabel='Average Page Views', figsize=(15,15))
